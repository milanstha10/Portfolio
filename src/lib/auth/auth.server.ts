...
/**
 * Get the TanStack Start session manager.
 */
...
/**
 * Ensure that a Set-Cookie header created by the session manager
 * remains attached to the current server-function response.
 *
 * This is particularly important when running server functions
 * through Vercel.
 */
...
export async function signIn(
  ...
  // Run password verification even when no user exists.
  ...
  /*
   * Make sure the Set-Cookie generated by the session
   * manager is preserved on the server-function response.
   */
